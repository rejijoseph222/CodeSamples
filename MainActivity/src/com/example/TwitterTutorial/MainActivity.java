...
public class MainActivity extends ListActivity {
	...
	final static String ScreenName = "ShashiTharoor";
	...
	private class DownloadTwitterTask extends AsyncTask<String, Void, String> {
		final static String CONSUMER_KEY = "LX9s0WBWk2XHv9qySBUzQ";
		final static String CONSUMER_SECRET = "JpDbUiPGCGNOdfSdI3T4KKGXX1RRg2ej4FL1UGi2kg";
