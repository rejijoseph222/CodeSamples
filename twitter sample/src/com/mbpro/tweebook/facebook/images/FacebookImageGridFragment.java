...
import com.mbpro.tweebook.facebook.FacebookListAlbumPhotos;
import com.mbpro.tweebook.facebook.FacebookListAlbums;
import com.mbpro.tweebook.facebook.images.util.DiskLruCache;
 ...
 */
public class FacebookImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
     ...
     */
    public FacebookImageGridFragment() {}
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        final Intent i = new Intent(getActivity(), FacebookImageDetailActivity.class);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.facebook_albums_menu, menu);
    }
