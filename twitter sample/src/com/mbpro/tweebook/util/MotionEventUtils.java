...
public class MotionEventUtils {
	...
	static {
		try {
			MotionEvent.class.getMethod("getPointerId",
					new Class[] { int.class });
	...
	/**
	 * A wrapper around newer (SDK level 5) MotionEvent APIs. This class only
	 * gets loaded if it is determined that these new APIs exist on the device.
	 */
