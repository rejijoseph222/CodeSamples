...
package com.mbpro.tweebook.util;
...
public class ActivityHelper {
	...
	public static ActivityHelper createInstance(Activity activity) {
		return UIUtils.isHoneycomb() ? new ActivityHelperHoneycomb(activity)
	...
	/**
	 * Invoke "home" action, returning to {@link com.twitterapp.ui.HomeActivity}
	 * .
	 */
	public void goHome() {
	...
	public void setupActionBar(CharSequence title, int color) {
		...
		/*
		 * if (title != null) { // Add Home button
		 * /addActionButtonCompat(R.drawable.ic_title_home,
		 * R.string.description_home, homeClickListener, true);
		 * 
		 * // Add title text TextView titleText = new TextView(mActivity, null,
		 * R.attr.actionbarCompatTextStyle);
		 * titleText.setLayoutParams(springLayoutParams);
		 * titleText.setText(title); actionBarCompat.addView(titleText);
		 * 
		 * } else {
		 */
		// Add logo
		...
		/*
		 * if (title != null) { TextView titleText = new TextView(mActivity,
		 * null, R.attr.actionbarCompatTextStyle);
		 * titleText.setLayoutParams(springLayoutParams);
		 * titleText.setText(title); actionBarCompat.addView(titleText); }
		 */
	...
	private View addActionButtonCompat(int iconResId, int textResId,
		...
		actionButton.setLayoutParams(new ViewGroup.LayoutParams((int) mActivity
				.getResources().getDimension(R.dimen.actionbar_compat_height),
				ViewGroup.LayoutParams.FILL_PARENT));
